  ...
  return (
    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '150px 20px 60px', lineHeight: '1.8', color: '#333', fontFamily: 'sans-serif' ,position: 'relative',
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '20px', fontWeight: 'bold', color: '#5b21b6' }}>제1조 (목적 및 서비스 성격)</h2>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '20px', fontWeight: 'bold', color: '#5b21b6' }}>제2조 (외부 데이터 활용 및 저작권 고지)</h2>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '20px', fontWeight: 'bold', color: '#5b21b6' }}>제3조 (이용자의 의무)</h2>
        <p>이용자는 본 서비스가 비상업적 OTT 통합플랫폼임을 인지하고 사용해야 합니다.</p>
        <p>본 서비스의 데이터를 무단으로 복제하여 상업적으로 이용하는 행위를 금지합니다.</p>
      </section>

      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '20px', fontWeight: 'bold', color: '#5b21b6' }}>제4조 (책임의 제한)</h2>
