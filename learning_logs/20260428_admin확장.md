...
- 기존에 있던 모든 repository, service 파일 우선 수정 및 보완
- Global Exception Handler -> ErrorCode 검수
- Spring Security Confgig, CustomUserDetails
- JPA Auditing & Entity Lifecycle
...
## domain.common.validator -> StatusValidator 클래스 생성
- StatusValidator : domain 패키지 내에 유저와 리뷰의 상태를 체크하는 역할
```java
